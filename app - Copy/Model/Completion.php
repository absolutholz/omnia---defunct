...
class Completion extends AppModel {
	...
	public $belongsTo = array('CollectionItem', "Participation" => array(
	...
	public function cacheCompletionsByParticipationID ($participation_id) {
		$completions = $this->find('all', array("contain" => false, "conditions" => array("participation_id" => $participation_id)));		
